...
const Footer = () => {
  return (
    <div className="w-full bg-white py-24">
      <div className="md:max-w-[1480px] m-auto grid md:grid-cols-5  max-w-[780px]:grid-cols-2 max-w-[600px] px-4  md:px-0">
        ...
        <div>
          ...
          <form action="" className="py-2">
            <input type="text" className="w-full py-4 px-4 bg-[#F2F3F4] rounded" placeholder="Email here" />
            <button type="submit" className="max-[780px]:w-full my-4 px-5 py-3 rounded-md bg-[#20B486] text-white font-medium capitalize">subscribe now</button>
          </form>
        </div>
      </div>
    </div>
